...
export function loadConfig(overrides = {}) {
  ...
  for (const value of Object.values(result.effortByRole)) check(['high','xhigh'].includes(value), 'Допустимые effort: high, xhigh.');
...
export function publicConfig(c) { return { model:c.model, modelByRole:c.modelByRole, effortByRole:c.effortByRole, limits:c.limits, budgets:c.budgets }; }
